                                ...
                                <form method="post" enctype="multipart/form-data" action="{{ route('revenue.modify') }}"
                                    ...
                                    <div class="service-fields mb-3">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" type="text" name="note"
                                                        ...
                                                        placeholder="{{ __('pages.enter_your_notes') }}">@isset($revenues->id){{$revenues->note}}@endisset</textarea>
                                            ...
                                            <input type="hidden" Request::segment(7) !=0 ?
                                                value="{{Request::segment(7)}}" : value="" name="apartment_id">
                                        </div>
                                    </div>
                                    @isset($revenues->id)
                                    <input type="hidden" value="{{$revenues->id}}" name="id">
                                    @endisset
