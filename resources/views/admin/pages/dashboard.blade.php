                ...
                <div class="row row-cols-2">
                    ...
                    <div class="col-md-6 col-12">
                     ...
                     <div class="col-md-6 col-12">
                        <div class="container-tenant mb-4">
                            <div class="wrapper-tenant">
                                <h1>{{ __('pages.unpaid') }}</h1>
                                <div class="button-wrapper">
                                    <a href="{{ route('unpaid') }}" class="btn-tenant fill-tenant">{{ __('pages.unpaid') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="container-tenant mb-4">
                            <div class="wrapper-tenant">
                                <h1>{{ __('pages.posts') }}</h1>
                                <div class="button-wrapper">
                                    <a href="{{ route('posts') }}" class="btn-tenant fill-tenant">{{ __('pages.posts') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
