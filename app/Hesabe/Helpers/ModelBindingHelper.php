...
use App\Hesabe\Misc\Constants;
use App\Hesabe\Models\HesabeCheckoutRequestModel;
use App\Hesabe\Models\HesabeCheckoutResponseModel;
use App\Hesabe\Models\HesabePaymentResponseModel;
...
class ModelBindingHelper
{
    ...
    public function getCheckoutRequestData($request)
    {
        ...
        //this description is used for sent it to the elkolify message which come from hesabe paymentgateway
         $this->hesabeCheckoutRequestModel->description = $request['description'];
        ...
        //we make it null because if the email is un valid it will not redirect to hesabe paymentgatway to complete payment
       // $this->hesabeCheckoutRequestModel->email = null;
